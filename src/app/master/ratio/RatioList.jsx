...
const RatioList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Ratio Range",
      cell: ({ row }) => (
        <div className="font-mono text-sm font-semibold text-stone-800 bg-[#FAF7F2] border border-[#E8E0D4] px-3 py-1 rounded-xl w-fit">
          {row.getValue("Ratio")}
        </div>
      ),
    },
      ...
      <div className="w-full space-y-3.5 pt-1">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3.5 bg-[#FDFBF7] border border-stone-200/80 px-5 py-3.5 rounded-2xl shadow-2xs">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="relative w-full sm:w-64 flex items-center">
              ...
              <Input
                placeholder="Search ratio range..."
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-2">
          <div className="text-xs md:text-sm text-stone-500 font-medium">
            Total Ratios: <span className="font-semibold text-stone-800">{table.getFilteredRowModel().rows.length}</span>
          </div>
