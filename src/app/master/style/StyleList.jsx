...
const StyleList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      id: "Style",
      header: "Style Name",
      cell: ({ row }) => <div className="font-medium text-stone-800">{row.getValue("Style")}</div>,
    },
      ...
      <div className="w-full space-y-3.5 pt-1">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-2">
          <div className="text-xs md:text-sm text-stone-500 font-medium">
            Total Styles: <span className="font-semibold text-stone-800">{table.getFilteredRowModel().rows.length}</span>
          </div>
