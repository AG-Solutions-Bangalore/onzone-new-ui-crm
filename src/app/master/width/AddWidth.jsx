    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        {pathname === "/master/width" ? (
          ...
          >
            <SquarePlus className="h-4 w-4" /> Add Width
          </Button>
        ) : (
          <Button
            variant="ghost"
      ...
      <PopoverContent className="w-80 bg-white border border-stone-200 rounded-2xl shadow-xl p-5" align="end">
        <div className="grid gap-4">
          <div className="space-y-1">
            <h4 className="font-heading font-bold text-stone-800 leading-none">
              Create New Width
            </h4>
            <p className="text-xs text-stone-500">
              Enter the fabric or roll measurement width
            </p>
          </div>
          <div className="grid gap-3">
            <Input
              id="width_mea"
              placeholder="e.g. 44, 58, 60 inches"
