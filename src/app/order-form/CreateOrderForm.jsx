  ...
  const handleBarcodeScan = (e) => {
    if (e.key === "Enter") {
      ...
      if (barcode) {
        ...
        // If no empty SKU, proceed as before
        setCurrentBarcode(barcode);
    ...
    if (emptyItem) {
      const updatedItems = items.map((item) =>
        item.id === emptyItem.id
          ? { ...item, barcode: currentBarcode, quantity }
          : item
      );
      setItems(updatedItems);
                ...
                <div className="lg:hidden overflow-hidden">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-600 truncate">
                            {searchParams.order_retailer || "No retailer"} •{" "}
                  ...
                  <div className="fixed bottom-0 left-0 md:left-12 right-0 bg-white border-t border-gray-200 p-2 flex justify-between">
                    ...
                    <Button
                      ...
                      disabled={
                        items.length === 0 || submitOrderMutation.isPending
                      }
                    ...
                    <div className="lg:w-1/3 border-r p-3 bg-blue-50 flex flex-col">
                      <div className="space-y-2 flex-grow">
                        <div className="grid grid-cols-4 items-center gap-1">
                          ...
                          <p className="text-xs font-medium col-span-3 truncate">
                            {searchParams.order_retailer || "Not specified"}
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-4 gap-1">
                          ...
                          <p className="text-xs col-span-3 line-clamp-2">
                            {searchParams.order_remarks || "Not specified"}
                          </p>
                        </div>
                        ...
                        <div className="pt-1">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <div className="flex items-center gap-1">
                              <Badge
                                variant={
                                  scanningActive ? "default" : "secondary"
                                }
                          ...
                          <Table>
                            <TableHeader className="sticky top-0 bg-white z-10">
                              <TableRow className="bg-blue-50 hover:bg-blue-50">
                                <TableHead className="w-10 py-1 text-xs">
                                  #
                                </TableHead>
                                <TableHead className="py-1 text-xs">
                                  SKU
                                </TableHead>
                                <TableHead className="w-24 py-1 text-xs">
                                  Quantity
                                </TableHead>
      ...
      <Dialog open={barcodeModalOpen} onOpenChange={setBarcodeModalOpen}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter className="sm:justify-between gap-2">
            ...
            >
              {items.find((item) => item.barcode === currentBarcode)
                ? "Update Order"
                : "Add to Order"}
            </Button>
          </DialogFooter>
